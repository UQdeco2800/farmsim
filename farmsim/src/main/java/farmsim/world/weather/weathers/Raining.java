...
public class Raining extends Weather {
    ...
    /**
     * Raining weather Constructor.
     */
    public Raining() {
        super();
        this.setNameType("Raining", WeatherType.RAINING);
        setPath("weather/icons/cloud_rain64.png");
        this.loadComponents();
    }
    ...
    private void loadComponents() {
        ...
        WeatherComponent clouds = new Clouds(1, 3);
        WeatherComponent temperature = new Temperature(2, 4);
